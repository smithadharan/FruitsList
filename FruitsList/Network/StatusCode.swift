...
enum StatusCode: Int {
    ...
    static func findOrReturnUndefined(statusCode: Int?) -> StatusCode {
        if let statusCode: Int = statusCode,
            let httpStatusCode: StatusCode = StatusCode(rawValue: statusCode) {
            return httpStatusCode
        }
        return StatusCode(rawValue: StatusCode.undefined.rawValue)!
    }
